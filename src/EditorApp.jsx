...
export default function EditorApp({ venueId, onSave, onHome, saveStatus }) {
    ...
    return (
      <ThemeContext.Provider value={t}>
        ...
        <div style={{ height: '100vh', overflowY: 'auto', background: t.appBg }}>
          ...
          <ErrorBoundary><VenueRenderer venueData={data} /></ErrorBoundary>
        </div>
  ...
  return (
    <ThemeContext.Provider value={t}>
      {!online && <OfflineBanner />}
      <Toolbar onPreview={() => setPreview(true)} onSave={onSave} onHome={onHome} saveStatus={saveStatus} />
